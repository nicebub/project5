...
void Assembler::outputToFileSectionNames(std::ofstream& file) {
	...
	file << std::hex << (Program::register_t)0x72;
	file << std::hex << (Program::register_t)0x74;
...
void Assembler::outputToFileHeader(const string& header, std::ofstream& file) {
	if(header == "ELF") {
		...
		file << std::hex << (Program::register_t)0x46;  // F
		file << std::hex << (Program::register_t)0x01;  // 1 32-bit , 2 64-bit
		file << std::hex << (Program::register_t)0x02;  // 1 little endian 2 big
		file << std::hex << (Program::register_t)0x01;  // 1 for current ELF ver
		file << std::hex << (Program::register_t)0x00;  // ABI 0 is none
		file << std::hex << (Program::register_t)0x00;  // ABI ver, ignored
		file << std::hex << (Program::register_t)0x00;  // PADDING
		file << std::hex << (Program::register_t)0x00;  // PADDING
		file << std::hex << (Program::register_t)0x00;  // PADDING
		file << std::hex << (Program::register_t)0x00;  // PADDING
		file << std::hex << (Program::register_t)0x00;  // PADDING
		...
		file << std::hex << (Program::register_t)0x00;  // OJBECT TYPE 2 BYTES
		file << std::hex << (Program::register_t)0x02;  // 00 none,01,reloc,02 exec
		file << std::hex << (Program::register_t)0x00;  // ISA 2 BYTES
		file << std::hex << (Program::register_t)0x00;  // ISA 00 is none specified
		file << std::hex << (Program::register_t)0x00;  // e_version 4 BYTES
		file << std::hex << (Program::register_t)0x00;
		file << std::hex << (Program::register_t)0x00;
		file << std::hex << (Program::register_t)0x01;  // set to version 1

		file << std::hex << (Program::register_t)0x00;  // e_entry 4 BYTES
		file << std::hex << (Program::register_t)0x00;  // for 32-bit, 8 BYTES for 64
		file << std::hex << (Program::register_t)0x00;  // memory address of entry
		file << std::hex << (Program::register_t)0x74;  // point
		...
		*/
		...
		file << std::hex << (Program::register_t)0x00;  // program header
		file << std::hex << (Program::register_t)0x00;  // entry 1
		file << std::hex << (Program::register_t)0x00;
		file << std::hex << (Program::register_t)0x06;  // Loadable segment
		...
		file << std::hex << (Program::register_t)0x00;  // 4 BYTES
		file << std::hex << (Program::register_t)0x00;  // reserved p_paddr
		file << std::hex << (Program::register_t)0x00;  // physical address
		file << std::hex << (Program::register_t)0x00;

		file << std::hex << (Program::register_t)0x00;  // p_filesz 4 BYTES
		file << std::hex << (Program::register_t)0x00;  // byte size of segment
		file << std::hex << (Program::register_t)0x00;  // in file can be 0
		file << std::hex << (Program::register_t)0x40;

		file << std::hex << (Program::register_t)0x00;  // p_memsz 4 BYTES
		file << std::hex << (Program::register_t)0x00;  // byte size of segment
		file << std::hex << (Program::register_t)0x00;  // in memory can be 0
		file << std::hex << (Program::register_t)0x40;

		file << std::hex << (Program::register_t)0x00;  // p_flags 4 BYTES
		file << std::hex << (Program::register_t)0x00;  // 32-bit
		file << std::hex << (Program::register_t)0x00;  // segment dependent
		file << std::hex << (Program::register_t)0x00;

		file << std::hex << (Program::register_t)0x00;  // p_align 4 BYTES 0 and 1
		...
		file << std::hex << (Program::register_t)0x00;  // program header
		file << std::hex << (Program::register_t)0x00;  // entry 2
		file << std::hex << (Program::register_t)0x00;
		file << std::hex << (Program::register_t)0x01;  // Loadable segment
		...
		file << std::hex << (Program::register_t)0x00;  // byte size of segment
		file << std::hex << (Program::register_t)0x00;  // in file can be 0
		file << std::hex << (Program::register_t)0x8F;
...
void Assembler::outputToFileSegmentTable(std::ofstream& file) {
	...
	file << std::hex << (Program::register_t)0x00;
																...
																// start of a section header
	file << std::hex << (Program::register_t)0x00;  // sh_name 4 BYTES
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x0B;

	file << std::hex << (Program::register_t)0x00;  // sh_type 4 BYTES
	file << std::hex << (Program::register_t)0x00;  // 0x1 program data
	file << std::hex << (Program::register_t)0x00;  // 0x8 bss(no data)
	file << std::hex << (Program::register_t)0x01;  // others

	file << std::hex << (Program::register_t)0x00;  // sh_flags 4 BYTES
	file << std::hex << (Program::register_t)0x00;  // 0x1 writeable
	file << std::hex << (Program::register_t)0x00;  // 0x2 in mem during exec
	file << std::hex << (Program::register_t)0x06;  // 0x4 executable 0x20 has
	...
	file << std::hex << (Program::register_t)0x00;  // sh_offset 4 BYTES
	file << std::hex << (Program::register_t)0x00;  // offset of section in file
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x74;

	file << std::hex << (Program::register_t)0x00;  // sh_size 4 BYTES
	file << std::hex << (Program::register_t)0x00;  // size of section
	file << std::hex << (Program::register_t)0x00;  // bytes in file
	file << std::hex << (Program::register_t)0x0A;  // may be 0

	file << std::hex << (Program::register_t)0x00;  // sh_link 4 BYTES
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // sh_info 4 BYTES
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // sh_addralign 4 BYTES
	file << std::hex << (Program::register_t)0x00;  // must be power of 2
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	...
	file << std::hex << (Program::register_t)0x00;  // name
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x01;

	file << std::hex << (Program::register_t)0x00;  // type
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x03;

	file << std::hex << (Program::register_t)0x00;  // flags
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // address
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // offset
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x7E;

	file << std::hex << (Program::register_t)0x00;  // size
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x11;

	file << std::hex << (Program::register_t)0x00;  // shlink
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // info
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // addralign
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;

	file << std::hex << (Program::register_t)0x00;  // entsize
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
	file << std::hex << (Program::register_t)0x00;
}
